...
class CineNetModule(MriModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--num_cascades", default=4, type=int, help="Number of iterations")
        parser.add_argument("--chans", default=18, type=int, help="Number of channels in CineNet blocks")
        parser.add_argument("--pools", default=3, type=int, help="Number of U-Net pooling for U-Net in CineNet blocks")
        parser.add_argument("--dynamic_type", default='XF', choices=['XF', 'XT', '2D', '3D', 'CRNN'], type=str,
                            help="Architectural variation for dynamic reconstruction. Options are ['XF', 'XT', '2D', '3D', 'CRNN']")
        parser.add_argument("--weight_sharing", default=True, type=bool,
        ...
        parser.add_argument("--lambda_", default=np.log(np.exp(1) - 1.) / 1., type=float,
                            help="Init value of data consistency block (DCB)")
